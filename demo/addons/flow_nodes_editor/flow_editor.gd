...
func populatePopupMenu() -> PopupMenu:
	...
	var cat_map = {
		...
		"Splines": ["create_spline", "sample_spline", "distance", "scan_splines", "clip_points_by_polygon", "clip_paths", "polygon_operation", "spline_to_segment", "create_surface_from_spline", "create_surface_from_polygon"],
