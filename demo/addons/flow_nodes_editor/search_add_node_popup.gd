...
func setup(p_node_types: Dictionary, p_inputs: Array, p_outputs: Array, _p_has_selected_nodes: bool, p_req_in: int = FlowData.DataType.Invalid, p_req_out: int = FlowData.DataType.Invalid):
	...
	var cat_map = {
		...
		"Spatial": ["create_spline", "distance", "ray_cast", "physics_overlap_query", "physics_shape_sweep", "clip_points_by_polygon", "clip_paths", "polygon_operation", "spline_to_segment", "create_surface_from_spline", "create_surface_from_polygon"],
